...
\item % Write the values of the parameters of the PID
  Our found PID values are found to be
...
\item % plot realizations of ...
  ...
  respectively.
  \begin{figure}
    \includegraphics[width=\linewidth]{Images/3.7.1-theta_b.PNG}
    \caption{The realization of $\theta_b(t)$ for the system in Fig.~\ref{fig:simulink-scheme}.}
    \label{fig:lin-theta_b}
  \end{figure}
  \begin{figure}
    \includegraphics[width=\linewidth]{Images/3.7.1-x_w.PNG}
    \caption{The realization of $x_w(t)$ for the system in Fig.~\ref{fig:simulink-scheme}.}
    \label{fig:lin-x_w}
  \end{figure}
  \begin{figure}
    \includegraphics[width=\linewidth]{Images/3.7.1-v_m.PNG}
    \caption{The realization of $v_m(t)$ for the system in Fig.~\ref{fig:simulink-scheme}.}
    \label{fig:lin-v_m}
  \end{figure}
  \begin{figure}
    \includegraphics[width=\linewidth]{Images/3.7.1-d.pdf}
    \caption{The realization of $d(t)$ for the system in Fig.~\ref{fig:simulink-scheme}.}
    \label{fig:lin-d}
  \end{figure}
\end{enumerate}
...
\item % discuss what was understood from these expiremints
  We did not iterate on the PID parameters during or after simulating
