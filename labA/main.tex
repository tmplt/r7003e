...
\item % plot realizations of cont. and disc.
  ...
  \begin{figure}
    \centering
    \begin{tabular}{cc}
        \subcaptionbox{Realization of $\theta_b(t)$.\label{fig:cont-theta_b}}{\includegraphics[width=0.5\linewidth]{Images/}}&
        \subcaptionbox{Realization of $v_m(t)$.\label{fig:cont-v_m}}{\includegraphics[width=0.5\linewidth]{Images/}}
      &
        \subcaptionbox{Realization of $\theta^{lin}_b(t)$.\label{fig:cont-lin-theta_b}}{\includegraphics[width=0.5\linewidth]{Images/}}
      &
        \subcaptionbox{Realization of $v^{lin}_m(t)$.\label{fig:cont-lin-v_m}}{\includegraphics[width=0.5\linewidth]{Images/}}
      \\
    \end{tabular}
  ...
  % \begin{figure}
  %   \includegraphics[width=\linewidth]{Images/3.9.1-cont,non-lin,out.pdf}
  %   \caption{The realization of $\theta_b(t)$ using a continuous controller.}
  %   \label{fig:cont-theta_b}
  % \end{figure}
  % \begin{figure}
  %   \includegraphics[width=\linewidth]{Images/3.9.1-cont,non-lin,in.pdf}
  %   \caption{The realization of $v_m(t)$ using a continuous controller.}
  %   \label{fig:cont-v_m}
  % \end{figure}
  % \begin{figure}
  %   \includegraphics[width=\linewidth]{Images/3.9.1-cont,lin,out.pdf}
  %   \caption{The realization of $\theta^{lin}_b(t)$ using a continuous
  %     controller.}
  %   \label{fig:cont-lin-theta_b}
  % \end{figure}
  % \begin{figure}
  %   \includegraphics[width=\linewidth]{Images/3.9.1-cont,lin,in.pdf}
  %   \caption{The realization of $v^{lin}_m(t)$ using a continuous controller.}
  %   \label{fig:cont-lin-v_m}
  % \end{figure}
  ...
  respectively.
    ...
    \centering
    \begin{tabular}{cc}
        \subcaptionbox{Realization of $\theta_b(k)$.\label{fig:disc-theta_b}}{\includegraphics[width=0.5\linewidth]{Images/}}&
        \subcaptionbox{Realization of $v_m(k)$.\label{fig:disc-v_m}}{\includegraphics[width=0.5\linewidth]{Images/}}
      &
        \subcaptionbox{Realization of $\theta^{lin}_b(k)$.\label{fig:disc-lin-theta_b}}{\includegraphics[width=0.5\linewidth]{Images/}}
      &
        \subcaptionbox{Realization of $v^{lin}_m(k)$.\label{fig:disc-lin-v_m}}{\includegraphics[width=0.5\linewidth]{Images/}}
      \\
    \end{tabular}
  ...
  % \begin{figure}
  %   \includegraphics[width=\linewidth]{Images/3.9.1-disc,non-lin,out.pdf}
  %   \caption{The realization of $\theta_b(k)$ using a continuous controller.}
  %   \label{fig:disc-theta_b}
  % \end{figure}
  % \begin{figure}
  %   \includegraphics[width=\linewidth]{Images/3.9.1-disc,non-lin,in.pdf}
  %   \caption{The realization of $v_m(k)$ using a continuous controller.}
  %   \label{fig:disc-v_m}
  % \end{figure}
  % \begin{figure}
  %   \includegraphics[width=\linewidth]{Images/3.9.1-disc,lin,out.pdf}
  %   \caption{The realization of $\theta^{lin}_b(k)$ using a continuous
  %     controller.}
  %   \label{fig:disc-lin-theta_b}
  % \end{figure}
  % \begin{figure}
  %   \includegraphics[width=\linewidth]{Images/3.9.1-disc,lin,in.pdf}
  %   \caption{The realization of $v^{lin}_m(k)$ using a continuous controller.}
  %   \label{fig:disc-lin-v_m}
  % \end{figure}
