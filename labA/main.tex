...
\item For the Continuous Linear
  \begin{figure}[H]
      \centering
      \includegraphics[width=\textwidth]{labA/Images/3.9.1-cont,lin,out.pdf}
      \caption{Continuous Linear $\theta^{lin}_b(t)$}
      \label{fig:my_label}
  \end{figure}
  \begin{figure}[H]
      \centering
      \includegraphics[width=\textwidth]{labA/Images/3.9.1-cont,lin,in.pdf}
      \caption{Continuous Linear $v^{lin}_m(t)$}
      \label{fig:my_label}
  \end{figure}
  \newpage
   For the Continuous non-Linear
  \begin{figure}[H]
      \centering
      \includegraphics[width=\textwidth]{labA/Images/3.9.1-cont,non-lin,in.pdf}
      \caption{Continuous non-Linear $\
      v_m(t)$}
      \label{fig:my_label}
  \end{figure}
   \begin{figure}[H]
      \centering
      \includegraphics[width=\textwidth]{labA/Images/3.9.1-cont,non-lin,out.pdf}
      \caption{Continuous non-Linear $\
      \theta_b(t)$}
      \label{fig:my_label}
  \end{figure}
  \newpage
   For the Discrete Linear
    \begin{figure}[H]
      \centering
      \includegraphics[width=\textwidth]{labA/Images/3.9.1-disc,lin,in.pdf}
      \caption{Discrete Linear $\
      v^{lin}_m(t)$}
      \label{fig:my_label}
  \end{figure}
  \begin{figure}[H]
      \centering
      \includegraphics[width=\textwidth]{labA/Images/3.9.1-disc,lin,out.pdf}
      \caption{Discrete Linear $\
      \theta^{lin}_b(t)$}
      \label{fig:my_label}
  \end{figure}
   \begin{figure}[H]
      \centering
      \includegraphics[width=\textwidth]{labA/Images/3.9.1-disc,non-lin,in.pdf}
      \caption{Discrete non-Linear $\
      V_m(t)$}
      \label{fig:my_label}
  \end{figure}
  \begin{figure}[H]
      \centering
      \includegraphics[width=\textwidth]{labA/Images/3.9.1-disc,non-lin,out.pdf}
      \caption{Discrete non-Linear $\
      \theta_m(t)$}
      \label{fig:my_label}
  \end{figure}
  \item We did not iterate the PID-Model after simulating, the simulation showed our PID to be sufficient to \emph{stabilize} the system.
\end{enumerate}
